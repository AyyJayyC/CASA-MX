...
export function getItem(entity) {
  ...
  try {
    ...
    logger.logError(err, `Error reading ${entity}`);
    return null;
  }
}
...
export function setItem(entity, data) {
  ...
  try {
    ...
    logger.logError(err, `Error writing ${entity}`);
  }
}
...
export function removeItem(entity) {
  ...
  try {
    ...
    logger.logError(err, `Error removing ${entity}`);
  }
}
...
export function clear() {
  ...
  try {
    ...
    logger.logError(err, "Error clearing storage");
  }
}
