...
const basePropertySchema = z.object({
  ...
  parkingSpaces: numberInput(z.number().int().min(0, 'Los cajones de estacionamiento no pueden ser negativos')).optional(),
  miniSplits: numberInput(z.number().int().min(0, 'Los mini splits no pueden ser negativos')).optional(),
