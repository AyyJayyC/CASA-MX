...
const basePropertySchema = z.object({
  ...
  parkingSpaces: optionalNumberInput(z.number().int().min(0, 'Los cajones de estacionamiento no pueden ser negativos')),
  miniSplits: optionalNumberInput(z.number().int().min(0, 'Los mini splits no pueden ser negativos')),
