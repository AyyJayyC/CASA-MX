...
export const NOTIFICATION_TYPE_COLORS = {
  ...
  offer_received: 'bg-amber-50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-800',
  ...
  review_received: 'bg-yellow-50 dark:bg-yellow-900/10 border-yellow-200 dark:border-yellow-800',
};
