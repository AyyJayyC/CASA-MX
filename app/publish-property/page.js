    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center py-8 px-4">
      <div className="max-w-2xl w-full">
          ...
          <Link href="/upload/sale">
            <button className="w-full h-full">
              <div className="
                ...
                hover:border-clay-400 dark:hover:border-clay-600
        ...
        <div className="text-center mt-8">
          <Link 
            href="/properties"
            className="text-clay-600 dark:text-clay-400 hover:text-clay-700 dark:hover:text-clay-300 font-medium transition-colors"
          >
