            ...
            <div className="space-y-3">
              {pendingRoles.map((role) => (
                <button
                  ...
                  className="w-full p-4 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:border-clay-400 dark:hover:border-clay-500 bg-white dark:bg-neutral-800 hover:bg-clay-50 dark:hover:bg-clay-900/20 transition-all text-left group"
                >
                  <div className="font-semibold text-neutral-900 dark:text-neutral-100 group-hover:text-clay-600 dark:group-hover:text-clay-400">
