export default function TerminosPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 prose dark:prose-invert">
      ...
      <p>
        El usuario que publica una propiedad declara que la información proporcionada es verídica,
        que cuenta con los derechos para comercializarla y que los documentos de propiedad son
        auténticos. La publicación de información falsa o fraudulenta dará lugar a la eliminación
        inmediata del listado y a las acciones legales correspondientes.
      </p>

      <h2>5. Créditos y pagos</h2>
      <p>
        El acceso a los datos de contacto de compradores interesados requiere el uso de créditos
        prepagados. Los créditos no son reembolsables una vez utilizados.
      </p>
      ...
      <p>
        ...
        se someterá a los tribunales competentes de la Ciudad de México.
      </p>
