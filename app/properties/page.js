                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {hasFilters && (
                      <button
                        onClick={clearFilters}
                        className="text-xs text-clay dark:text-clay hover:text-clay dark:hover:text-amber-300 font-medium"
                      >
                        Limpiar
                      </button>
                    )}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-md text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-clay focus:border-transparent"
                      >
                        <option value="">Todos</option>
                        {estadosDisponibles.map((item) => (
                          <option key={item} value={item}>{item}</option>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        disabled={!estado}
                        className="w-full px-3 py-2 bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-md text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-clay focus:border-transparent disabled:opacity-60"
                      >
                        <option value="">Todas</option>
                        {ciudadesDisponibles.map((item) => (
                          <option key={item} value={item}>{item}</option>
