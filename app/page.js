...
export default function Home() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative py-14 md:py-20 px-4 bg-gradient-to-br from-sand-50 via-white to-sand-100 dark:from-ink dark:via-ink/95 dark:to-ink/90">
        <div className="container max-w-3xl text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-ink dark:text-sand-50 mb-4 leading-tight">
            Encuentra tu camino en el mercado inmobiliario.
          </h1>
          <p className="text-base md:text-lg text-ink-muted dark:text-sand-200 mb-8 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              ...
              className="px-6 py-3 bg-clay hover:bg-clay-500 text-white font-semibold text-base rounded-lg transition-all shadow-md hover:shadow-lg"
            >
              Publicar propiedad
            </Link>
            <Link
              href="/properties"
              className="px-6 py-3 bg-white dark:bg-ink border-2 border-sand-200 dark:border-slate-700 text-ink dark:text-sand-50 hover:border-clay dark:hover:border-clay font-semibold text-base rounded-lg transition-all"
            >
