...
export default function Home() {
  return (
    <div>
      {/* Full-Screen Hero Carousel — dominant first impression */}
      <HomepageCarousel />

      {/* Compact CTA Banner — directly below carousel */}
      <section className="py-8 md:py-10 px-4 bg-gradient-to-br from-sand-50 via-white to-sand-100 dark:from-ink dark:via-ink/95 dark:to-ink/90">
