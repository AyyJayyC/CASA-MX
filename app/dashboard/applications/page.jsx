...
const ApplicationsTable = dynamic(
  () => import("../../../components/ApplicationsTable.jsx"),
  { ssr: false },
);
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              <svg
                className="animate-spin h-12 w-12 text-clay mx-auto mb-4"
                viewBox="0 0 24 24"
              >
                <circle
          ...
          <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-12 text-center">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mb-6">
              Publica propiedades para renta para que los inquilinos puedan
              solicitar.
            </p>
            <Link
              href="/properties"
