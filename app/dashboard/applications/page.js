  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container max-w-7xl py-8">
        ...
        {timeoutError && (
          <div className="mb-6 p-4 bg-clay-50 dark:bg-clay-900/20 border border-clay-200 dark:border-clay-800 rounded-lg text-clay-800 dark:text-clay-300 text-sm">
            {timeoutError}
          </div>
        )}
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              <svg className="animate-spin h-12 w-12 text-clay-600 mx-auto mb-4" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${selectedPropertyId === prop.id
                        ...
                        : 'border-neutral-200 dark:border-neutral-700 hover:border-clay-400'
                      }
                    `}
                  >
                    ...
                    <div className="text-sm font-semibold text-clay-600 dark:text-clay-400 text-left mt-2">
