...
export default function AccountPage() {
  ...
  async function handleFileChange(e) {
    ...
    try {
      await uploadUserDocument(file, pendingType, (pct) =>
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 mb-8">
        Gestiona tu información y documentos de identidad.
      </p>
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
        ...
        <p className="text-xs text-gray-500 mb-4">
          El check de suscripción activa aparece cuando tu cuenta tiene una
          suscripción recurrente vigente.
        </p>
        <p
          className={`text-sm font-medium ${paidSubscriber ? "text-emerald-700" : "text-gray-700"}`}
        >
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <p className="text-xs text-gray-500 mb-4">
          Tu identificación oficial (INE/IFE) es requerida para verificar
          propiedades. Una vez subida, queda pendiente de verificacion hasta su
          aprobacion.
        </p>
                  ...
                  <>
                    ...
                    {officialIdDoc?.reviewNote && (
                      <p className="text-xs text-red-500 mt-0.5">
                        Motivo: {officialIdDoc.reviewNote}
                      </p>
                    )}
                  </>
                ) : hasINE ? (
                  <p className="text-xs text-blue-600 mt-0.5">
                    Documento subido, pendiente de verificacion
                  </p>
                ) : (
