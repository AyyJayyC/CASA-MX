...
export default function NotificationsPage() {
  ...
  const handleMarkRead = async (id) => {
    ...
    setData(d => ({
      ...d,
      unreadCount: Math.max(0, d.unreadCount - (d.notifications.find(n => n.id === id && !n.read) ? 1 : 0)),
    ...
    <div className="container max-w-3xl py-8">
      ...
      {data.notifications.length === 0 ? (
        <div className="text-center py-16 bg-neutral-50 dark:bg-neutral-800 rounded-xl">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">Sin notificaciones aún</p>
        </div>
      ) : (
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${TYPE_COLORS[n.type] || 'bg-neutral-100 text-neutral-700'}`}>
