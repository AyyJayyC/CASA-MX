              ...
              {showAuthenticated ? (
                <>
                  ...
                  <Link href="/settings" onClick={() => { setNotifOpen(false); setPropertiesDropdownOpen(false); }}
                    className="px-3 py-1.5 rounded-lg text-sm font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">⚙️ Ajustes</Link>
