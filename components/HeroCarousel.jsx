...
export default function HeroCarousel({ properties }) {
  ...
  const imgSrc = !isPlaceholder
    ? p.imageUrls?.[0] || p.photos?.[0] || p.imageUrl || fallbackSvg
    : null;
    ...
    <section className="relative w-full overflow-hidden bg-[#1A1A18] h-[50vh] sm:h-[55vh] md:h-[500px] lg:h-[600px]">
      ...
      {!isPlaceholder ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white/70 mb-2">
            Tu propiedad aquí
          </h2>
          <p className="text-white/40 max-w-xs text-sm mb-4">
