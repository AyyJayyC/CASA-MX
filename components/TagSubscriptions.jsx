  ...
  return (
    <div className="space-y-5">
      <p className="text-sm text-neutral-600 dark:text-neutral-400">
        Recibe notificaciones cuando se publique una propiedad en las áreas que
        te interesan.
      </p>

      {error && (
        <p className="text-sm text-red-600 bg-red-50 dark:bg-red-900/20 rounded-lg p-2">
          {error}
        </p>
      )}
      {success && (
        <p className="text-sm text-green-600 bg-green-50 dark:bg-green-900/20 rounded-lg p-2">
          {success}
        </p>
      )}
