...
const PROPERTY_TYPE_META = {
  ...
  Departamento: {
    emoji: "🏢",
    description: "Práctico para ciudad y renta urbana.",
  },
  Terreno: { emoji: "🌄", description: "Espacio para desarrollar o invertir." },
  "Local comercial": {
    emoji: "🛍️",
    description: "Pensado para negocio o showroom.",
  },
  Oficina: { emoji: "💼", description: "Lista para operación profesional." },
  Bodega: {
    emoji: "📦",
    description: "Almacenaje, logística o trabajo pesado.",
  },
};
  ...
  return (
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
      {PROPERTY_TYPE_OPTIONS.map((option) => {
        const meta = PROPERTY_TYPE_META[option] || {
          emoji: "🏘️",
