...
export default function PromotePropertyModal({
  propertyId,
  propertyTitle,
  onClose,
}) {
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-xl max-w-md w-full p-6 space-y-5 max-h-[90vh] overflow-y-auto">
        ...
        {success ? (
          <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg space-y-2">
            ...
            <button
              onClick={onClose}
              className="mt-2 w-full px-4 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold text-sm transition-colors"
            >
              Cerrar
            </button>
          </div>
          ...
          <>
              ...
              <div className="grid grid-cols-1 gap-2">
                {TIERS.map((t) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-clay-600 dark:text-clay-400 mt-1 font-medium">
                      {t.costPerDay.toLocaleString()} créditos/día
                    </p>
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold text-clay-600 dark:text-clay-400">
                  {days} días
                </span>
              </div>
              <input
            ...
            <div className="flex justify-between items-center p-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
              ...
              <span className="text-lg font-bold text-clay-600 dark:text-clay-400">
                {totalCost.toLocaleString()} créditos
              </span>
            </div>
