...
function PropertiesContent() {
  ...
  useEffect(() => {
    ...
    if (prefs.minConstructionMeters)
      setMinConstructionMeters(prefs.minConstructionMeters);
    if (prefs.maxConstructionMeters)
      setMaxConstructionMeters(prefs.maxConstructionMeters);
  ...
  const coloniasDisponibles = [
    ...new Set([...coloniasCatalogo, ...coloniasDesdeDatos]),
  ].sort((a, b) => a.localeCompare(b, "es-MX"));
            ...
            <div className={`lg:block ${showFilters ? "block" : "hidden"}`}>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-neutral-500 dark:text-neutral-500 text-center">
                      MXN {parseInt(minRent).toLocaleString("es-MX")} -{" "}
                      {parseInt(maxRent).toLocaleString("es-MX")}
                    </div>
                  </div>
                </div>
              )}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-1">
                      <input
                        type="number"
                        placeholder="Mín"
                        value={minConstructionMeters}
                        onChange={(e) =>
                          setMinConstructionMeters(e.target.value)
                        }
                      ...
                      <input
                        type="number"
                        placeholder="Máx"
                        value={maxConstructionMeters}
                        onChange={(e) =>
                          setMaxConstructionMeters(e.target.value)
                        }
                        className="w-full px-2 py-1.5 bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded text-sm"
                      />
                    </div>
              ...
              <div className="pt-4 border-t border-neutral-200 dark:border-neutral-800">
                ...
                <div className="space-y-2">
                  {(listingType === "for_rent"
                    ? SERVICE_OPTIONS_RENT
                    : SERVICE_OPTIONS_SALE
                  ).map((svc) => (
                    <label
                      key={svc}
                      className="flex items-center gap-2 cursor-pointer"
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={
                        !estado || !ciudad
                          ? "Selecciona estado y ciudad"
                          : "Buscar o escribir colonia"
                      }
