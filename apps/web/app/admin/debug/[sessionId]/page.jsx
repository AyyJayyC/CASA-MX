                    ...
                    {event.type === "error" && (
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`px-2 py-0.5 text-xs rounded ${getSeverityColor(event.severity)}`}
                          >
                            {event.severity}
                          </span>
                          {event.resolved && (
                    ...
                    {event.type === "api" && (
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`text-sm font-semibold ${getStatusColor(event.responseStatus)}`}
                          >
